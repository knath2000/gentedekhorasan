...
const Star = ({ top, left, delay, size }: { top: string; left: string; delay: string; size: string }) => (
  <div
    className={`absolute rounded-full bg-desertHighlightGold animate-twinkle ${size}`}
    style={{
      top,
      left,
...
const Background = () => {
  ...
  return (
    <div className="absolute inset-0 -z-10 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-skyDeepBlue via-skyPurple to-skyIndigo opacity-95" />
